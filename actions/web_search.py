...
def _gemini_search(query: str) -> str:
    ...
    try:
        ...
        # Thought (düşünce) bloklarını süzerek temiz yanıtı topluyoruz
        text_parts = []
        ...
        # Kota dolduğunda veya hata aldığında sessizce geç
        pass

    # Gemini başarısız olursa otomatik olarak DuckDuckGo aramasına devam eder
...
def _ddg_news(query: str, max_results: int = 8) -> list[dict]:
    ...
    try:
        ...
        # Düşük ihtimalle modül düzeyinde import edilirse
        import ddgs as DDGS

    results = []
    try:
        # Yeni sürümlerde 'with' bloğu kullanmadan doğrudan çağırıyoruz
        ddg = DDGS()
        news_results = ddg.news(query, max_results=max_results)
